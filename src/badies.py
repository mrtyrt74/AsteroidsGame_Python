...
class Rock(VectorSprite):
    ...
    def __init__(self, stage, position, rockType):
        ...
        newPointList = [scale(point, scale) for point in pointlist]
...
class Saucer(Shooter):
    ...
    def __init__(self, stage, saucerType, ship):                
        ...
        newPointList = [scale(point, self.scales[saucerType]) for point in self.pointlist]
